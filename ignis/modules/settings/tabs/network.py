...
class NetworkTab(widgets.Box):
            ...
            widgets.Box(
                ...
                child=[
                    ...
                    SettingsRow(
                        ...
                        description="Открыть панель сетевых настроек в GNOME Settings для расширенной конфигурации.",
                        child=[
                            Button.button(
                                icon="barefoot",
                                label="Открыть",
                    ...
                    SettingsRow(
                        ...
                        description="Вручную обновить статус всех сетевых подключений.",
                        child=[
                            Button.button(
                                icon="refresh",
                                label="Обновить",
    ...
    async def update_ui(self):
        ...
        self.ethernet_status_label.label = (
            "Подключено" if eth_connected else "Отключено"
        )
        ...
        if wifi_service.enabled:
            ...
            self.wifi_list_box.append(
                widgets.Label(label="Wi-Fi отключён.", halign="center", vexpand=True)
            )
    ...
    def create_network_category(self):
        ...
        box.append(CategoryLabel("Wi-Fi и Ethernet"))
        ...
        box.append(
            SettingsRow(
                ...
                description="Выберите сеть для подключения.",
                vertical=True,
        ...
        box.append(
            SettingsRow(
                title="Статус Ethernet",
                description="Статус Ethernet-подключения.",
                vertical=True,

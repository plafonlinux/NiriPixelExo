...
class Clock:
    def __init__(self):
        self.container = widgets.Box(css_classes=["clock-inner"], hexpand=True, vexpand=True)
        ...
        self._button = widgets.Button(
            ...
            css_classes=["clock", "flat"],
            hexpand=True,
            vexpand=True,
            tooltip_text="Открыть календарь",
            on_click=lambda _: subprocess.Popen(
                ["gnome-calendar"], start_new_session=True
            ),
        )
